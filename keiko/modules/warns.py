...
from keiko import dispatcher, BAN_STICKER, WHITELIST_USERS, SARDEGNA_USERS
from keiko.modules.disable import DisableAbleCommandHandler
from keiko.modules.helper_funcs.chat_status import (is_user_admin, bot_admin, user_admin_no_reply, user_admin,
                                                     can_restrict)
from keiko.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from keiko.modules.helper_funcs.filters import CustomFilters
from keiko.modules.helper_funcs.misc import split_message
from keiko.modules.helper_funcs.string_handling import split_quotes
from keiko.modules.log_channel import loggable
from keiko.modules.sql import warns_sql as sql
...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # keiko's sticker
        keyboard = []
