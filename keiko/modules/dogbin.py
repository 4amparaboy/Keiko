...
__help__ = """
 - /dogbin: Create a paste or a shortened url using [dogbin](https://del.dog)
 - /getdogbin: Get the content of a paste or shortened url from [dogbin](https://del.dog)
 - /dogbinstats: Get stats of a paste or shortened url from [dogbin](https://del.dog)
"""
